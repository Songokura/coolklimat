...
var TICK_KZ = ["Орнату","Қара әрлеу кезеңі","Сату","Қызмет көрсету","Фреон құю","Жөндеу","Бөлшектеу","Биіктіктегі жұмыс","Заңды тұлғаларға"];
...
if (form) form.addEventListener("submit", function(e){
  ...
  var L = curLang();
  var t = (L === "kk"
    ? "Сәлеметсіз бе! CoolКлимат сайтынан өтінім.\nАты: " + name + "\nТелефон: " + phone + (msg ? "\nНе керек: " + msg : "")
    : "Здравствуйте! Заявка с сайта CoolКлимат.\nИмя: " + name + "\nТелефон: " + phone + (msg ? "\nЧто нужно: " + msg : ""));
  ok.hidden = false;
  conv("lead");
